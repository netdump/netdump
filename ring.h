...
#define RING_FORCE_INTRINSICS 0
 ...
 */
static inline int
ring_atomic32_cmpset(volatile uint32_t *dst, uint32_t exp, uint32_t src)
{
#ifndef RING_FORCE_INTRINSICS
    uint8_t res;
			 ...
			 unsigned n, enum ring_queue_behavior behavior)
{
	...
	do {
		...
		success = ring_atomic32_cmpset(&r->prod.head, prod_head,
					      prod_next);
		 ...
		 unsigned n, enum ring_queue_behavior behavior)
{
	...
	do {
		...
		success = ring_atomic32_cmpset(&r->cons.head, cons_head,
					      cons_next);
	} while (unlikely(success == 0));
 ...
 */
static inline int __attribute__((always_inline))
ring_mp_enqueue_bulk(ring_t *r, void * const *obj_table, unsigned n)
{
 ...
 */
static inline int __attribute__((always_inline))
ring_sp_enqueue_bulk(ring_t *r, void * const *obj_table,
			 unsigned n)
{
 ...
 */
static inline int __attribute__((always_inline))
ring_enqueue_bulk(ring_t *r, void * const *obj_table,
		      unsigned n)
{
 ...
 */
static inline int __attribute__((always_inline))
ring_mp_enqueue(ring_t *r, void *obj)
{
 ...
 */
static inline int __attribute__((always_inline))
ring_sp_enqueue(ring_t *r, void *obj)
{
 ...
 */
static inline int __attribute__((always_inline))
ring_enqueue(ring_t *r, void *obj)
{
	if (r->prod.sp_enqueue)
 ...
 */
static inline int __attribute__((always_inline))
ring_mc_dequeue_bulk(ring_t *r, void **obj_table, unsigned n)
{
 ...
 */
static inline int __attribute__((always_inline))
ring_sc_dequeue_bulk(ring_t *r, void **obj_table, unsigned n)
{
 ...
 */
static inline int __attribute__((always_inline))
ring_dequeue_bulk(ring_t *r, void **obj_table, unsigned n)
{
 ...
 */
static inline int __attribute__((always_inline))
ring_mc_dequeue(ring_t *r, void **obj_p)
{
 ...
 */
static inline int __attribute__((always_inline))
ring_sc_dequeue(ring_t *r, void **obj_p)
{
 ...
 */
static inline int __attribute__((always_inline))
ring_dequeue(ring_t *r, void **obj_p)
{
	if (r->cons.sc_dequeue)
 ...
 */
static inline int __attribute__((always_inline))
ring_mp_enqueue_burst(ring_t *r, void * const *obj_table,
			 unsigned n)
{
 ...
 */
static inline int __attribute__((always_inline))
ring_sp_enqueue_burst(ring_t *r, void * const *obj_table,
			 unsigned n)
{
 ...
 */
static inline int __attribute__((always_inline))
ring_enqueue_burst(ring_t *r, void * const *obj_table,
		      unsigned n)
{
	if (r->prod.sp_enqueue)
 ...
 */
static inline int __attribute__((always_inline))
ring_mc_dequeue_burst(ring_t *r, void **obj_table, unsigned n)
{
 ...
 */
static inline int __attribute__((always_inline))
ring_sc_dequeue_burst(ring_t *r, void **obj_table, unsigned n)
{
 ...
 */
static inline int __attribute__((always_inline))
ring_dequeue_burst(ring_t *r, void **obj_table, unsigned n)
{
	if (r->cons.sc_dequeue)
