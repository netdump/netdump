 ...
 */
void ieee802_11_if_print(void * infonode, const struct pcap_pkthdr *h, const u_char *p)
{
 ...
 */
void ieee802_11_radio_if_print(void * infonode, const struct pcap_pkthdr *h, const u_char *p)
{
...
/*
    ...
    */
void ieee802_11_radio_avs_if_print(void *infonode, const struct pcap_pkthdr *h, const u_char *p)
{
 ...
 */
void prism_if_print(void *infonode, const struct pcap_pkthdr *h, const u_char *p)
{
